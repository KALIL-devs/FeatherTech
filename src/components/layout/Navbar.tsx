...
export default function Navbar() {
  return (
    <nav className="mx-auto mt-6 flex w-[85%] items-center justify-around rounded-full bg-[#1F3D2E] px-10 py-5">

      {/* Logo */}
      <Link href="/" className="flex items-center gap-3 font-semibold text-white">
        <span className="flex h-[26px] w-[26px] items-center justify-center rounded-full bg-[#D2FF3A]">

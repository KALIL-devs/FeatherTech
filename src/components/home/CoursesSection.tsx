    ...
    <section style={{ backgroundColor: "#FCFBF7", padding: "88px 28px" }} className="rounded-t-[36px] rounded-b-[36px]">
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "48px", flexWrap: "wrap", gap: "16px" }}>
          <div>
            <p style={{ fontSize: "11.5px", fontWeight: 500, letterSpacing: "2.5px", textTransform: "uppercase", color: "#1F3D2E", marginBottom: "10px" }}>
              What We Offer
            </p>
            <h2 style={{
              ...
              <span style={{ color: "#1F3D2E", fontStyle: "italic" }}>Real Careers</span>
            </h2>
          </div>
          <Link href="/courses" style={{
            display: "inline-flex", alignItems: "center", gap: "8px",
            padding: "11px 24px", borderRadius: "9px",
            border: "1.5px solid #1F3D2E", color: "#1F3D2E",
            fontSize: "13px", fontWeight: 500, textDecoration: "none",
            transition: "all 0.18s ease",
          }}
            onMouseEnter={e => { e.currentTarget.style.backgroundColor = "#1F3D2E"; e.currentTarget.style.color = "#FCFBF7"; }}
            onMouseLeave={e => { e.currentTarget.style.backgroundColor = "transparent"; e.currentTarget.style.color = "#1F3D2E"; }}>
            View All Courses

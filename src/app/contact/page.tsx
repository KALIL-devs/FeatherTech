  ...
  return (
    <>
      ...
      <main style={{ paddingTop: "20px" }}>
        {/* Hero */}
        <section style={{ backgroundColor: "#004B23", padding: "80px 28px", textAlign: "center" }}>
          <div style={{ maxWidth: "640px", margin: "0 auto" }}>
            ...
            <h1 style={{
              ...
              We&apos;d Love to<br />
              <span style={{ color: "#B5E48C", fontStyle: "italic" }}>Hear From You.</span>
            </h1>
          </div>
        </section>
        ...
        <section style={{ backgroundColor: "#F0EFE9", padding: "72px 28px" }}>
          <div style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: "40px", alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <div style={{ backgroundColor: "#004B23", borderRadius: "18px", padding: "32px 28px" }}>
                ...
                {contactInfo.map((item) => (
                  <div key={item.label} style={{ display: "flex", gap: "14px", marginBottom: "20px" }}>
                    ...
                    <div>
                      <p style={{ fontSize: "10.5px", letterSpacing: "1px", textTransform: "uppercase", color: "#B5E48C", marginBottom: "3px" }}>{item.label}</p>
            ...
            <div style={{ backgroundColor: "#FFFFFF", borderRadius: "20px", border: "1px solid #E8E4DC", padding: "40px 36px" }}>
              {submitted ? (
                <div style={{ textAlign: "center", padding: "40px 0" }}>
                  ...
                  <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "24px", fontWeight: 700, color: "#004B23", marginBottom: "10px" }}>
                    Message Received!
                  </h2>
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                      <div>
                        ...
                        <input required value={form.name} onChange={e => setForm({ ...form, name: e.target.value })}
                          ...
                          onFocus={e => { e.target.style.borderColor = "#004B23"; }}
                    ...
                    <button type="submit" style={{
                      ...
                      onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#9dd470"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 6px 20px rgba(181,228,140,0.5)"; }}
                      onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#B5E48C"; (e.currentTarget as HTMLButtonElement).style.boxShadow = "none"; }}>
                      Submit Message →
                    </button>
                  </form>
                </>
